...
urlpatterns = [
    ...
    path('links', landing_views.links, name='links'),
    ...
    path('staff/', landing_views.login_view, name="login"),
    path('staff/logout', landing_views.logout_view, name="logout"),
    ...
    path('staff/formularios/respuestas/<str:form>', landing_views.form_answers, name="form_answers")
