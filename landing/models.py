...
class Profile(models.Model):
    ...
    role = models.CharField(max_length=5, choices=ROLES, default=OPERATOR)
...
class ticket_image_evidence(models.Model):
    id = models.AutoField(primary_key=True)
    client_name = models.CharField(max_length=300, default="", blank=True)
    ticket_image = models.ImageField(upload_to="landing/images/ticket_evidence", null=True)
    created = models.DateTimeField(default=timezone.now)
