  ...
  $.getJSON("../static/js/sucursales.json", function (data) {
    ...
    if ($.inArray(neiborhood, ajusco) >= 0) {
      window.location.replace(
        window.location.origin + "/cobertura?sucursal=ajusco"
      );
    } else if ($.inArray(neiborhood, aztecas) >= 0) {
      window.location.replace(
        window.location.origin + "/cobertura?sucursal=aztecas"
      );
    } else if ($.inArray(neiborhood, coapa) >= 0) {
      window.location.replace(
        window.location.origin + "/cobertura?sucursal=coapa"
      );
    } else if ($.inArray(neiborhood, ayuntamiento) >= 0) {
      window.location.replace(
        window.location.origin + "/cobertura?sucursal=ayuntamiento"
      );
    } else if ($.inArray(neiborhood, marina) >= 0) {
      window.location.replace(
        window.location.origin + "/cobertura?sucursal=marina"
      );
    } else if ($.inArray(neiborhood, cafetales) >= 0) {
      window.location.replace(
        window.location.origin + "/cobertura?sucursal=cafetales"
      );
      ...
      alert(
        "Lo sentimos por el momento no tenemos cobertura en esa dirección, haz tu pedido y recoge en sucursal.",
        "warning"
      );
